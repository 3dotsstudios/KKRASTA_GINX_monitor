...
func showToolName() {
	...
	lightBlue.Printf("                                        KKRASTA_GINX Monitor Community Edition\n\n")
	fmt.Printf("                                               by %s %s     version %s\n\n",
		lightBlue.Sprint("KKRASTA_GINX"),
		red.Sprint("(@kkrasta_ginx)"),
...
func showHelp() {
	fmt.Println(`
KKRASTA_GINX Credential Monitor

Usage:
  ./kkrasta_ginx_monitor [OPTIONS]
